...
describe("products", () => {
   ...
   */
  describe("GET /api/products : Success : No documents in Product", () => {
   ...
   * Expected to return a 200 OK status code.
   */
  describe("POST /api/products & GET /api/products : Success : One document in Product", () => {
    it("Delete all documents in Product collection", (done) => {
      setTimeout(() => {
        Product.deleteMany({}, (err) => {
          done();
    ...
    it("Return an array containing the added Product with a 200 OK status code.", (done) => {
      chai
        .request(app)
        .get("/api/products")
        .end((err, res) => {
